...
@media(max-width:768px){
  ...
  .poster-img { width: 100px; height: 150px; margin-left: 50px; }
  .rank-number { font-size: clamp(60px, 25vw, 120px); left: -10px; bottom: -15px; }
  .arrow-left, .arrow-right { width: 30px; height: 50px; font-size: 1.5rem; }
}
...
/* --- AJUSTE MOBILE REFINADO V3 - O ARSENAL DE GAMES --- */
@media (max-width: 768px) {

  /* 1. Ajuste do Banner Principal e Topo do Site */
  .pinning-header { height: 60px; }
  
  /* Sobe o conteúdo inicial para evitar buracos no topo */
  .banner { 
    height: 35vh !important; 
    margin-top: 0;
  }

  /* 2. Banner Black Friday com respiro agradável embaixo */
  .top10-banner {
    margin-bottom: 15px !important; /* Os 10% de espaço que você pediu */
    margin-top: 10px;
  }

  /* 3. Títulos colados nos cards abaixo (Harmonizando o buraco) */
  .row {
  ...
  .row h2 {
    ...
    margin-bottom: 20px !important; /* Cola o título no card */
    margin-top: 0px !important;
    padding-left: 15px;
  }

  /* 4. Números e Cards do Top 10 (Ajuste de invasão) */
  .card-container {
    position: relative;
    min-width: 32% !important;
    margin-right: 18px !important; /* Aumentei um pouco para o número não bater no vizinho */
  }
  ...
  .rank-number {
    ...
    -webkit-text-stroke: 1.5px #888 !important;
    letter-spacing: -8px;
  }
  ...
  /* 5. Combo Centralizado e Vertical */
  .games-scroll {
    display: flex !important;
    gap: 10px !important;
    padding: 5px 15px 20px 15px !important; /* Respiro embaixo para o botão comprar */
  }
  ...
  .games-scroll::-webkit-scrollbar, .top-10-scroll::-webkit-scrollbar {
    display: none;
  }
}
...
#banner-logo {
    width: 100%;
    max-width: 300px; /* Define o tamanho máximo da logo */
    height: auto;
    margin-bottom: 15px;
    display: block;
    /* Esse filtro faz a logo "saltar" do vídeo, dando profundidade */
